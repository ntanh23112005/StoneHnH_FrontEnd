...
import ReviewHomestayForm from "../components/homestays/homestayDetail/homestayReviews/reviewHomestayForm";
import { calculateHomestayRating } from "../utils/caculateHomeRating";
...
const HomestayDetailPage = () => {
  ...
  const { homestay, homestayRule, images, customer, rates } = data;

  const ratingSummary = calculateHomestayRating(rates);
  ...
  return (
    <div style={{ padding: "24px 48px" }}>
      ...
      <Row gutter={24}>
        ...
        <Col span={8}>
          <SafetyInfo
            safetyItems={extractSafety(homestayRule.ruleText).join(",")}
          />
        </Col>
        <Col span={8}>
      ...
      <HomestayRatingSummary rate={ratingSummary} />
