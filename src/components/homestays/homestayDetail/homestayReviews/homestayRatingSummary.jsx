...
const HomestayRatingSummary = ({ rate }) => {
  ...
  const categories = [
    { label: "Giá cả", value: rate.avgPrice },
    { label: "Vị trí", value: rate.avgLocation },
    { label: "Giao tiếp", value: rate.avgCommunication },
    { label: "Đúng mô tả", value: rate.avgExactly },
    { label: "Vệ sinh", value: rate.avgCleanliness },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {rate.averageRateTotal.toFixed(1)}
          <span
            style={{ fontSize: "20px", fontWeight: "400", marginRight: "20px" }}
          >
            {" "}
            / 5
          </span>
